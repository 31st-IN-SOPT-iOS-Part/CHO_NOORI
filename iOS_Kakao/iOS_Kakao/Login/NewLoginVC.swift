...
class NewLoginVC: UIViewController {
    ...
    private lazy var newloginButton = UIButton().then {
        ...
        $0.addTarget(self, action: #selector(touchupThirdButton), for:.touchUpInside)
    }
...
extension NewLoginVC{
    ...
    private func NewLoginLayout(){
        ...
        passwordLineField2.snp.makeConstraints{
            ...
            $0.leading.equalTo(self.passwordTextField2)
            $0.width.equalTo(333)
            $0.height.equalTo(1)
        }
        
        newloginButton.snp.makeConstraints{
            $0.top.equalTo(self.passwordTextField2.snp.bottom).offset(26)
            $0.leading.equalTo(self.emailTextField)
            $0.width.equalTo(333)
            $0.height.equalTo(44)
        }
